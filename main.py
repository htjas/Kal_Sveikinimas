...
def ending(speed, name):
    ...
    flex(speed, "", "", "", "")
    flex(speed, "", "", "", "")
    flex(speed, name + " sportuoja.", "", "", "")
    flex(speed, name + " sportuoja.", "", "", "")
    flex(speed, name + " sportuoja.", "Būk kaip " + name + ".", "", "")
    flex(speed, name + " sportuoja.", "Būk kaip " + name + ".", "", "")
    flex(speed, name + " sportuoja.", "Būk kaip " + name + ".", "SU ŠVENTOM KALĖDOM!!!", "")
    flex(speed, name + " sportuoja.", "Būk kaip " + name + ".", "SU ŠVENTOM KALĖDOM!!!", "")
    while True:
        flex(speed, name + " sportuoja.", "Būk kaip " + name + ".", "SU ŠVENTOM KALĖDOM!!!", "P.S. kai užknis flexint, tai paspausk ctrl-c")
